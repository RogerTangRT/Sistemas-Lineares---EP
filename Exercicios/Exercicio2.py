...
def Questao22():
    ...
    print('1.79769313486231[60]e+308:', 1.7976931348623160e+308)
    ...
    print('1.7976931348623157e+308 + 1e23:', 1.7976931348623157e+308 + 10e-23)
...
def Questao23():
    ...
    imprimeTitulo('Resposta')
    print('Segundo a função (sys.float_info.dig), são ',
...
def Questao28(nusp):
    ...
    # Resposta
    # Número USP Inteiro 12553156
    # Número USP Inteiro (binário) 0b101111111000101111000100
    imprimeTitulo('Resposta')
...
def Questao29(nusp):
    ...
    print('(−1)0 × ​2(10000010110−01111111111) ​× ​1.0111111100010111100010000000000000000000000000000000')
    input("Press Enter to continue...")
